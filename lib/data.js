...
export const layout = {
  ...
  "2/F": [
    ...
    { col: 11, code: "S211", name: "室內體育館" },
  ],
  "1/F": [
    { col: 1, code: "S101", name: "輔導組/後備班房" }, { col: 2, code: "S102", name: "圖書館" },
    { col: 4, code: "S104", name: "多用途活動室" }, { col: 5, code: "S105", name: "家政室" },
    { col: 7, code: "S107", name: "Band Room" }, { col: 8, code: "S108", name: "健身室及英語角" },
    { col: 9, code: "S109", name: "多用途活動室" },
  ],
  "G/F": [
    { col: 1, code: "SG01", name: "校務處" }, { col: 2, code: "SG02", name: "社工室" },
    { col: 3, code: "SG03", name: "社工室" },
  ],
};
...
export const occupancy = {
  ...
  "2025-07-21": { label: "7月21日 (二)", rooms: {
    S201:{t:"YWS/TCL",p:"SEN試升"}, S203:{t:"YLP/MSW",p:"補課"}, S204:{t:"LHW/LKR",p:"補課"},
    S205:{t:"SCM/LSH",p:"補課"}, S206:{t:"YMY/LWS",p:"補課"}, S210:{t:"SYS",p:"補課"},
  ...
  "2025-07-22": { label: "7月22日 (三)", rooms: {
    ...
    S302:{t:"TLN",p:"補課"}, S303:{t:"WYC",p:"補課"}, S305:{t:"WCK",p:"補課"},
    S306:{t:"LYG",p:"補課"}, S311:{t:"TMC",p:"補課"}, S601:{t:"YWS/TCL",p:"SEN試升"},
    S602:{t:"YWS/TCL",p:"SEN試升"}, S701:{t:"TTC/LYF",p:"試升班會議"},
    S703:{t:"TTC",p:"學業試升"}, S704:{t:"TTC",p:"學業試升"},
    S705:{t:"TTC",p:"學業試升"}, S706:{t:"TTC",p:"學業試升"},
  }},
